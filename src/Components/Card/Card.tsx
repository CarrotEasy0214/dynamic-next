      ...
      <div className="pb-[0.5%] px-[4%]">
        <div className="ms:flex justify-between gap-[1.5%] pb-[1.5%]">
          <div className="cursor-pointer relative">
            <Image src={card1 as unknown as string} alt="" className="w-[100%] h-[100%] hidden ms:block" />
            <Image src={card1Mobile as unknown as string} alt="" className="w-[100%] h-[100%] block ms:hidden" />
          ...
          <div className="cursor-pointer relative mt-2 ms:mt-0">
            <Image src={card2 as unknown as string} alt="" className="w-[100%] h-[100%] hidden ms:block" />
            <Image src={card2Mobile as unknown as string} alt="" className="w-[100%] h-[100%] block ms:hidden" />
            <div className="absolute bottom-[8%] left-[7%]">
              <div className="text-white w-30 mb-2 lg:text-base text-sm font-bold">MH40 Wireless</div>
              <div className="border-b-[0.5px] border-solid border-white w-[18%] mb-[2.5%]"></div>
              <div className="text-white lg:text-xl text-lg font-semibold mb-[2.5%] w-[95%]">
        ...
        <div className="cursor-pointer relative">
          <Image src={card3 as unknown as string} alt="" className="w-[100%] h-[100%] hidden ms:block" />
          <Image src={card3Mobile as unknown as string} alt="" className="w-[100%] h-[100%] block ms:hidden" />
          <div className="absolute bottom-[8%] left-[7%]">
            <div className="text-white w-30 mb-2 lg:text-base text-sm font-bold">MH40 Wireless</div>
            <div className="border-b-[0.5px] border-solid border-white w-[18%] mb-[2.5%]"></div>
            <div className="text-white lg:text-xl text-lg font-semibold mb-[2.5%] w-[95%]">

    ...
    <div className="relative mb-8">
      ...
      >
        <SwiperSlide>
          ...
          <picture>
            <source srcSet={MobileImg1 as unknown as string} type="image/webp" media="(max-width: 700px)" />
            <Image src={slide1 as unknown as string} alt="" className="block" />
          </picture>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <picture>
            <source srcSet={MobileImg2 as unknown as string} type="image/webp" media="(max-width: 700px)" />
            <Image src={slide2 as unknown as string} alt="" className="block" />
          </picture>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <picture>
            <source srcSet={MobileImg3 as unknown as string} type="image/webp" media="(max-width: 700px)" />
            <Image src={slide3 as unknown as string} alt="" className="block" />
          </picture>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <picture>
            <source srcSet={MobileImg4 as unknown as string} type="image/webp" media="(max-width: 700px)" />
            <Image src={slide4 as unknown as string} alt="" className="block" />
          </picture>
        </SwiperSlide>
        <div className="w-8 h-8 xl:w-10 xl:h-10 absolute z-50 bottom-[3%] ms:bottom-[2.5%] xl:bottom-[2%] right-[1.3%] ms:right-[1.5%] xl:right-[2%]">
          <button onClick={toggleAutoplay}>
            {isPlaying ? (
              <Image src={PauseBtn} alt="" className="w-10 h-10" /> // 정지 아이콘
            ) : (
              <Image src={PlayBtn} alt="" className="w-10 h-10" /> // 재생 아이콘
            )}
          </button>
        </div>
      </Swiper>
